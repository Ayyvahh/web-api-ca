...
const SiteHeader = ({history}) => {
    ...
    const menuOptions = [
        ...
        {label: "Upcoming Movies", path: "/movies-frontend/upcoming"},
        {label: "Now in Cinemas", path: "/movies-frontend/nowShowing"},
        { label: "Must Watch", path: "/movies-frontend/mustWatch" },
        {label: "Favorite Movies", path: "/movies-frontend/favorites"},
